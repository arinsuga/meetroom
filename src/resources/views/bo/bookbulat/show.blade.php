...
@section('content_title', 'Booking Ruang Bulat Info')
...
<!-- button edit -->
<li class="nav-item">
    <a class="nav-link" href="{{ route('bookbulat.edit', ['bookbulat' => $viewModel->data->id]) }}">
...
<li class="nav-item">
    ...
    <form id="frmData" role="form" id="frmData" method="POST" action="{{ route('bookbulat.destroy', ['bookbulat' => $viewModel->data->id]) }}">
        @csrf
        @method('DELETE')
    </form>
</li>
