...
<div class="modal-dialog">
    ...
    <div class="modal-body">
        ...
        <form role="form" id="frmDataReject" method="POST" action="{{ route('bookinterior.update.reject', ['bookinterior' => $viewModel->data->id]) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
    ...
    <div class="modal-footer justify-content-between">
        ...
        <button onclick="rejectOrder();" type="button" class="btn btn-primary">Reject Order</button>
    </div>
    </div>
    <!-- /.modal-content -->
</div>
